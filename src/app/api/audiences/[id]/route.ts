/**
 * DELETE /api/audiences/[id] — permanently delete a custom audience on Meta
 * and remove the local mirror. Irreversible. `[id]` is the Meta audience id.
 */
...
export async function DELETE(
  ...
  try {
    const result = await deleteEntity({ level: "audience", metaId: id });
